...
class ViewFeatures : AppCompatActivity(), FilterAdapter.Clickcallback {
    ...
    override fun onResume() {
        ...
        GlobalScope.launch {
            ...
            runOnUiThread {
                binding.content.list.layoutManager=LinearLayoutManager(this@ViewFeatures)
                binding.content.list.adapter=FilterAdapter(this@ViewFeatures,this@ViewFeatures,uifilters)
            }
        }
